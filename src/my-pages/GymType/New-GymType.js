...
class NewGymType extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  newStatusHandler = (e) => {
    e.preventDefault();
    fetch(process.env.REACT_APP_API_ADDRESS + "/gymType/create", {
      method: "POST",
      headers: {
                      ...
                      <CCardBody style={{ width: "240%", marginRight: "40%" }}>
                        <CForm>
                          ...
                          <CFormGroup className="form-actions">
                            <CButton
                              onClick={(e) => this.newStatusHandler(e)}
                              block
                              size="md"
                              color="success"
                            >
...
export default connect(mapStateToProps)(
  withTranslation("translations")(NewGymType)
);
